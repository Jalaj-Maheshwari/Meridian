                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (name != null && !name.equals(""))
                                if (number != null && !number.equals("")) {
                                    ...
                                    com.example.android.meridian.sos.PersonManager.savePerson(p, context);
                                    toUpdate.setAdapter(new PersonAdapter(context, com.example.android.meridian.sos.PersonManager.getSavedPersons(context)));
                                }
                        }
                    })
